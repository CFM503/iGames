...
[![Latest Release](https://img.shields.io/badge/Release-v1.0.3-brightgreen.svg)](https://github.com/CFM503/iGames/releases/tag/v1.0.3)
...
| :--- | :--- | :--- |
| 🚀 **极速通道 1（推荐 v1.0.3）** | [⚡ 直接下载 iGames-v1.0.3.apk (gh-proxy.com)](https://gh-proxy.com/https://github.com/CFM503/iGames/releases/download/v1.0.3/iGames-release.apk) | 🇨🇳 **首选推荐**：国内直连响应最快、跑满宽带 |
| 🚀 **极速通道 2（专线 v1.0.3）** | [⚡ 备用下载 iGames-v1.0.3.apk (ghfast.top)](https://ghfast.top/https://github.com/CFM503/iGames/releases/download/v1.0.3/iGames-release.apk) | 🇨🇳 移动/联通/电信多线优化，大带宽极速直连 |
...
| 🌐 **GitHub 官方 Releases** | [前往 GitHub Release v1.0.3 页面](https://github.com/CFM503/iGames/releases/tag/v1.0.3) | 🌍 海外网络环境或已开启科学上网 |
